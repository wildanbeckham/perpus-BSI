...
<body class="bg-dark" style="background-image: url('assets/img/bg.jpg');">
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent h5">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url(); ?>"><h3>Pustaka</h3></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php } ?>
                    <span class="nav-item nav-link nav-right" style="display:block; margin-left:50px;">Selamat Datang <b><?= $user; ?></b></span>
