...
class Admin extends CI_Controller {     
    ...
    {         
        ...
        $detail = $this->db->query("SELECT*FROM booking,booking_detail,buku WHERE DAY(curdate()) < DAY(batas_ambil) AND booking.id_booking=booking_detail.id_booking And booking_detail.id_buku=buku.id")->result_array();         foreach ($detail as $key) 
        {  
            $id_buku = $key['id_buku'];             
